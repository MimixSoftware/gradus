...
CREATE TABLE study_sessions (
	...
	CONSTRAINT chk_study_sessions_start_time_step CHECK (SECOND(start_time) = 0 AND MINUTE(start_time) % 15 = 0),
	CONSTRAINT chk_study_sessions_duration_minutes CHECK (duration_minutes BETWEEN 15 AND 240),
	CONSTRAINT chk_study_sessions_duration_minutes_step CHECK (duration_minutes % 15 = 0),
